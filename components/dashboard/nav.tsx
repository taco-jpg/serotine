...
import { LayoutDashboard, MessageSquare, Users, Settings, LogOut, Shield, Contact } from "lucide-react"
...
export function DashboardNav() {
  ...
  const links = [
    ...
    { href: "/dashboard/groups", label: "Governance", icon: Users }, // Renamed Groups to Governance for clarity
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 py-8 px-4 space-y-2">
        <div className="mb-6 px-2">
          <p className="text-xs font-semibold text-muted-foreground uppercase tracking-widest mb-2">Navigation</p>
        </div>
        {links.map((link) => {
