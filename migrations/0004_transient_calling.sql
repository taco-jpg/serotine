-- SIP-3: dedicated ephemeral signaling; never reuse retained RelayEvent history.
CREATE TABLE IF NOT EXISTS CallPresence (
  publicKey TEXT NOT NULL,
  sessionId TEXT NOT NULL,
  peers TEXT NOT NULL,
  incomingPeers TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS CallSession (
  ...
  callerSession TEXT NOT NULL,
  recipientSession TEXT,
  status TEXT NOT NULL,
  createdAt INTEGER NOT NULL,
  inviteExpiresAt INTEGER NOT NULL,
  expiresAt INTEGER NOT NULL,
  callerAliveUntil INTEGER NOT NULL,
  recipientAliveUntil INTEGER NOT NULL,
  reason TEXT,
  noHistory INTEGER NOT NULL DEFAULT 0
);
